...
\pagestyle{fancy}
\lhead{\kaishu 中山大学物理与天文学院物理实验\uppercase\expandafter{\romannumeral2}} % 左边页眉，学院 + 课程
\rhead{\kaishu 基础物理实验 \ 偏振光实验} % 右边页眉，实验报告标题
...
\usetikzlibrary{patterns,decorations.markings,arrows.meta,bending,angles,quotes} % TikZ 包的拓展